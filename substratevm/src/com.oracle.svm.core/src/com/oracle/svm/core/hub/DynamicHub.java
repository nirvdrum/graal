...
// Checkstyle: disallow direct annotation access
    ...
    ReflectionData loadReflectionMetadata() {
        ...
        Set<Method> newDeclaredMethods = new HashSet<>(Arrays.asList(rd.declaredMethods));
        Set<Method> newPublicMethods = new HashSet<>(Arrays.asList(rd.publicMethods));
        Set<Constructor<?>> newDeclaredConstructors = new HashSet<>(Arrays.asList(rd.declaredConstructors));
        Set<Constructor<?>> newPublicConstructors = new HashSet<>(Arrays.asList(rd.publicConstructors));
        Set<Method> newDeclaredPublicMethods = new HashSet<>(Arrays.asList(rd.declaredPublicMethods));
    ...
    private void addInheritedPublicMethods(Set<Method> newPublicMethods, DynamicHub parentHub) {
